        ...
        ?>
                ...
                <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="mb-2 md:mx-2 lg:mx-2 border-solid border-gray-200 rounded border shadow-sm w-full md:w-1/2 lg:w-1/2"><br>
                                ...
                                <form class="w-full" method="POST">
                                    ...
                                    <div class="flex items-center border-b border-b-1 border-teal-500 py-2">
                                        <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="photo"
                                            name="photo" type="file" required="" aria-label="Photo">
                                    </div><br>
                                    <div>
                                        <button
                                    ...
                                    <table class="table text-grey-darkest">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='edit_product.php?P_ID=<?php echo $row['id'] ?>'><i
...
<?php
       ...
       $query = "INSERT INTO product VALUES ('','$product_name', '$category', '$status','$price','$photo');";

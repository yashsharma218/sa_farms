                    ...
                    <div class="flex flex-col">
                        <div class="mb-2 md:mx-2 lg:mx-2 border-solid border-gray-200 rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                            ...
                            <div class="font-bold text-xl">
                                &nbsp;&nbsp; Update Your Food Gallery Image Details
                            </div>
                            <div class="p-3">
                                <form class="w-full" method="POST" >
                                    ...
                                    <?php } ?>
                                    <div>
                                        <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit" name="update_details">Update Details</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="mb-2 md:mx-2 lg:mx-2 border-solid border-gray-200 rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                            ...
                            <div class="p-3">
                                <form class="w-full" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div>
                                        <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" type="submit" name="update_image">Change Product Picture</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
if (isset($_POST['update_image'])) {
    ...
    if (!move_uploaded_file($source, $dest)) {
        echo "<script>alert('Have Some Issue in Upload Profile Picture')</script>";
    } else {
        $sql = "UPDATE gallery SET image='$dest' where id='$id'";
...
?>
            <script>
                alert("Successfully / Product Picture Update..");
        ...
        ?>
            <script>
                alert("Failed / Product Picture Update Failed..");
                window.location.replace("gallery.php");
            </script>
<?php
        }
